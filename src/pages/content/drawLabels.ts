...
function getLabelData(
  ...
  function addLabel(name: string, elem: Element) {
    ...
    data.push(item);
    elem.setAttribute(ECHO_LABEL_ATTRIBUTE_NAME, uidString);
    uid++;
  }
  ...
  elements.forEach((elem) => {
    ...
    if (elem.hasAttribute(ECHO_LABEL_ATTRIBUTE_NAME)) return;
...
export function drawLabels(knowledge: Knowledge = {}): LabelData[] {
  ...
  removeAttributeFromAllElements(ECHO_LABEL_ATTRIBUTE_NAME);
